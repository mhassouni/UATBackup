...
(function () {
    ...
    function PushServices($q, sfdcService, $injector, StateService, $rootScope, FieldSetFieldsService, userSettingsManager) {
        ...
        var socket = void 0,
            ...
            resourceAbsenceFields = new Set(["Latitude", "Longitude", "AbsenceNumber", namespace + '__Gantt_Color__c', namespace + '__EstTravelTime__c', namespace + '__EstTravelTimeFrom__c', namespace + '__EstimatedTravelDistanceFrom__c', namespace + '__EstimatedTravelDistanceTo__c', "Start", "End", "Resource.Name", "Type", "TypeLabel", namespace + '__GanttLabel__c', "RecordType.DeveloperName", namespace + '__Approved__c', "isDeleted"]),
            livePositionFields = new Set(['LastKnownLocationDate', 'LastKnownLatitude', 'LastKnownLongitude']),
            assignedResourceFields = new Set(['ServiceResourceId', 'EstimatedTravelTime', namespace + '__EstimatedTravelTimeFrom__c']),
            ...
            if (Array.isArray(data)) {
                ...
                switch (data[0].messageType) {
                    ...
                    case 'FALLBACK_TO_DELTA':
                        closeSession();
                        writeErrorToSplunk('FALLBACK_TO_DELTA', data[0].data.message);
                        break;
