            ...
            if (!_.isEmpty(utils.statusFlow)) {
                ...
                if (!window.__gantt.ignoreReadonlyGantt226 && window.customPermissions.Show_Change_Status || window.__gantt.ignoreReadonlyGantt226) {
                    ...
                    for (var st in utils.statuses) {
                        ...
                        __serviceContextMenu.addNewChild('status', i, 'status_change_' + i, "<span class='StatusColorChanger " + cssStatusName + ' ' + utils.getCSSClassForContext(utils.statusesWithCategories[utils.statuses[st]], SERVICE_STATUS) + "'></span>" + utils.statusTranslations[utils.statuses[st]], false);
                ...
                if ($scope.selectedGanttServices.getSelected().length < 2) {
                    ...
                    if (!window.__gantt.ignoreReadonlyGantt226 && window.customPermissions.Show_Change_Status || window.__gantt.ignoreReadonlyGantt226) {
                        ...
                        for (var st in utils.statuses) {
                            ...
                            __multiServicesContextMenu.addNewChild('status', i, 'status_change_' + i, "<span class='StatusColorChanger " + cssStatusName + ' ' + utils.getCSSClassForContext(utils.statuses[st], SERVICE_STATUS) + "'></span>" + utils.statusTranslations[utils.statuses[st]], false);
                            menuItemsIdsToStatuses['status_change_' + i++] = utils.statuses[st];
                        }
                    }
